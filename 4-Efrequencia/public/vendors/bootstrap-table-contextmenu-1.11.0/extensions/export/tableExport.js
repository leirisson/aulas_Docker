    ...
    $.fn.extend({
        tableExport: function (options) {
            var defaults = {
                ...
                fileName: 'Relatório ' + (new Date().toLocaleString()),
                htmlContent: false,
                ignoreColumn: [],
                ignoreRow: [],
                ...
                jspdf: {orientation: 'l',
                    unit: 'pt',
                    format: 'bestfit', // jspdf page format or 'bestfit' for autmatic paper format selection
            ...
            if (defaults.type == 'csv' || defaults.type == 'txt') {
                ...
                docFile += '<meta http-equiv="content-type" content="application/vnd.ms-' + MSDocType + '; charset=ISO-8859-1">';
                docFile += "<head>";
                if (MSDocType === 'excel') {
            ...
            function base64encode(input) {
                ...
                var i = 0;
                /*
                 * nucre-pog linha comentada conforme dica em
                 * https://github.com/kayalshri/tableExport.jquery.plugin/issues/6
                 * Não estavam sendo processados no pdf os caracteres especiais
                 */
