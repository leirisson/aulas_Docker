...
<div class="modal-dialog modal-escala">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <h4>Visualizar Frequência - {{$frequencia->recesso->descricao}} - Janeiro</h4>
        </div>
        ...
        <div class="modal-footer">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <button id='button-abrir-modal-avaliar-frequencia-jan' type="button" class="btn btn-primary pull-right">Validar Frequência Janeiro</button>
                </div>
                @endif
            </div>
        </div>
...
<script>
    var botaoAbrirModalDesfazerEnvioChefia = $("#button-abrir-modal-avaliar-frequencia-jan");
    var modalValidarFrequencia = $("#modal-validar-frequencia-jan");
    var modalVisualizarFrequencia = $("#modal-visualizar-frequencia-jan");
    var paragrafoMensagem = $('#p-mensagem-validar-jan');
    botaoAbrirModalDesfazerEnvioChefia.click(function () {
        //Passando dados para um modal
        modalVisualizarFrequencia.modal('hide');
        paragrafoMensagem.text('Tem certeza que deseja validar a frequencia de Janeiro do servidor ' + modalVisualizarFrequencia.data('nome_servidor') + '?')
