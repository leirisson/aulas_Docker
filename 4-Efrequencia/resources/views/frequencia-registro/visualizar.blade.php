    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <div class="form-group row">
                ...
                @if($frequencia->status_id==2)
                <div class="col-sm-6">
                    <button id='button-abrir-modal-avaliar-frequencia' type="button" class="btn btn-primary pull-right">Validar Frequência</button>
                </div>
                @endif
            </div>
        </div>
...
<script>
    var botaoAbrirModalDesfazerEnvioChefia = $("#button-abrir-modal-avaliar-frequencia");
    var modalValidarFrequencia = $("#modal-validar-frequencia");
    var modalVisualizarFrequencia = $("#modal-visualizar-frequencia");
    var paragrafoMensagem = $('#p-mensagem-validar');
    botaoAbrirModalDesfazerEnvioChefia.click(function () {
        //Passando dados para um modal
        modalVisualizarFrequencia.modal('hide');
        paragrafoMensagem.text('Tem certeza que deseja validar a frequencia do servidor ' + modalVisualizarFrequencia.data('nome_servidor') + '?')
