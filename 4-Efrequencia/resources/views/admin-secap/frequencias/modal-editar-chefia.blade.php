...
<div class="modal-dialog">
    ...
    <div class="modal-content">
        <div class="modal-header">
            ...
            <p>
                Você pode redefinir a chefia que pode validar a frequência de {{$frequencia->servidorEscalado->nome}} 
                caso a atual chefia definida não puder validar a frequência.
            </p>
        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" id="select-servidores-editar" name="servidor_id" required style="width: 100%">
                            ...
                            <option value="{{$servidor->id}}"  {{$frequencia->avaliacoes[0]->servidor_id_disponivel_para == $servidor->id?"selected" : ''}}>{{$servidor->nome}}</option>
...
<script>
    ...
    var urlAlterar = 'frequencias/alterar-chefia';
