...
<div class="modal-dialog modal-escala">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body modal-body-escala">
            <form id="form-cadastrar-escala" method="POST">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <select class="form-control" id="select-servidores-editar" name="servidor_autoriza_id" required style="width: 100%">
                            <option value="">Selecione o servidor</option>
                            @forelse($servidores as $servidor)
                            <option value="{{$servidor->id}}"  {{$frequencia->servidor_autoriza_id == $servidor->id?"selected" : ''}}>{{$servidor->nome}}</option>
                            @empty
        ...
        <div class="modal-footer">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <button id='button-frequencia-editar-enviar' form="form-cadastrar-escala" type="submit" class="btn btn-primary pull-right">Salvar Alterações</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
     ...
     * listarServidores()
     */
    var formEditarRegistro = $('#form-cadastrar-escala');
